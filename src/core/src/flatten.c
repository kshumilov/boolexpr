...
static void _free_arrays(size_t n, struct BX_Array **arrays) {
...
static struct BX_Array **_nf2arrays(struct BoolExpr *nf) {
...
static struct BoolExpr *_distribute(BX_Kind kind, struct BoolExpr *nf) {
    size_t length = nf->data.xs->length;
    struct BX_Array **arrays;
...
static struct BoolExpr *_absorb(struct BoolExpr *nf) {
    size_t length = nf->data.xs->length;
    bool *keep;
    struct BX_Array **arrays;
    unsigned int val;
...
struct BoolExpr *BX_ToDNF(struct BoolExpr *ex) {
    struct BoolExpr *nnf;
    struct BoolExpr *dnf;
...
struct BoolExpr *BX_ToCNF(struct BoolExpr *ex) {
    struct BoolExpr *nnf;
    struct BoolExpr *cnf;
...
static struct BoolExpr *_complete_sum(struct BoolExpr *dnf) {
    if (BX_Depth(dnf) <= 1) {
...
struct BoolExpr *BX_CompleteSum(struct BoolExpr *ex) {
    struct BoolExpr *dnf;
    struct BoolExpr *sum;
