...
static struct BX_Array *_multiply(BX_Kind kind, struct BX_Array *a,
                                  struct BX_Array *b) {
...
static struct BX_Array *_product(BX_Kind kind, size_t n,
...
struct BX_Array *BX_Product(BX_Kind kind, size_t length,
                            struct BX_Array **arrays) {
