...
void BX_OrAndArgSet_Del(struct BX_OrAndArgSet *argset) {
    BX_Set_Del(argset->xs);
    free(argset);
}

bool BX_OrAndArgSet_Insert(struct BX_OrAndArgSet *argset,
                           struct BoolExpr *key) {
    /* 1 | x = 1 ; 0 & x = 0 */
    /* x | 0 = x ; x & 1 = x */
...
struct BoolExpr *BX_OrAndArgSet_Reduce(struct BX_OrAndArgSet *argset) {
    struct BoolExpr **xs;
...
void BX_XorArgSet_Del(struct BX_XorArgSet *argset) {
    BX_Set_Del(argset->xs);
    free(argset);
}

bool BX_XorArgSet_Insert(struct BX_XorArgSet *argset, struct BoolExpr *key) {
    if (BX_IS_CONST(key)) {
...
struct BoolExpr *BX_XorArgSet_Reduce(struct BX_XorArgSet *argset) {
    struct BoolExpr **xs;
...
void BX_EqArgSet_Del(struct BX_EqArgSet *argset) {
    BX_Set_Del(argset->xs);
    free(argset);
}

bool BX_EqArgSet_Insert(struct BX_EqArgSet *argset, struct BoolExpr *key) {
...
struct BoolExpr *BX_EqArgSet_Reduce(struct BX_EqArgSet *argset) {
    struct BoolExpr **xs;
    struct BoolExpr *y;
    size_t length = argset->xs->length;
