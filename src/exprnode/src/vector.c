...
void BX_Vector_Del(struct BX_Vector *vec) {
...
bool BX_Vector_Insert(struct BX_Vector *vec, size_t index,
                      struct BoolExpr *ex) {
...
bool BX_Vector_Append(struct BX_Vector *vec, struct BoolExpr *ex) {
